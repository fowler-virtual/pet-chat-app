        ...
        <Pressable style={styles.modal} onPress={() => {}}>
          {pet && (
            <>
              ...
              {step === 1 ? (
                <>
                  <Text style={styles.title}>{pet.name}とおわかれしますか？</Text>
                  <Text style={styles.message}>
                    おわかれすると{pet.name}との会話履歴もすべて消えてしまいます。
                  </Text>
                  <Pressable style={styles.dangerButton} onPress={onNextStep}>
                    <Text style={styles.dangerButtonText}>おわかれする</Text>
                  </Pressable>
                </>
              ) : (
                <>
                  <Text style={styles.title}>本当におわかれしますか？</Text>
                  <Text style={styles.message}>
